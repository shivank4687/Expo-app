...
export const PaymentsCard: React.FC = () => {
    const { data, loading, error, refetch } = usePaymentsStats();
    ...
    const formattedAmount = data?.formatted_amount ?? 'MX$ 0';

    return (
        <View style={styles.metricCard}>
            <View style={styles.metricHeader}>
                <Text style={styles.metricLabel}>Payments to be released</Text>
                <View style={styles.badge}>
                    <Text style={styles.badgeText}>Escrow</Text>
                </View>
            </View>
